...
if(!spAccess('r','dtkconfig')){  //读取设置
	$dtkconfig = spClass('db_setting')->getConfig();
	 spAccess('w','dtkconfig',$dtkconfig,36000);
	}else{
		$dtkconfig =  spAccess('r','dtkconfig');
 }
...
$GLOBALS['YB'] = $dtkconfig;
$GLOBALS['YB']['version'] = '1.8β build 120513';
$GLOBALS['YB']['soft'] = '地铁客';
$GLOBALS['YB']['url'] = 'http://www.ditieker.com';
$GLOBALS['YB']['email'] = 'ditieker@163.com';
$GLOBALS['YB']['copyright'] = 'FreeBSD License';
$GLOBALS['YB']['year'] = '2011 - '.date('Y',time());
$GLOBALS['YB']['author'] = '黑芝麻糊土著';
