<?php /* Smarty version Smarty-3.0.6, created on 2014-11-04 13:15:34
         compiled from "/home/kingkong/Projects/php/baby/tpl/theme/default/aside.html" */ ?>
<?php /*%%SmartyHeaderCode:599681386545860f62f0923-77000461%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '075a89da869c01bc163f609f0ef8daa558cc246f' => 
    array (
      0 => '/home/kingkong/Projects/php/baby/tpl/theme/default/aside.html',
      1 => 1336898970,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '599681386545860f62f0923-77000461',
  'function' => 
  array (
  ),
...
')">关注作者</a>
     ...
     <?php if ($_SESSION['uid']!=$_smarty_tpl->getVariable('user')->value['uid']){?>   <a href="javascript:void(0)" onClick="sendpm(<?php echo $_smarty_tpl->getVariable('uid')->value;?>
      ...
      <?php if ($_smarty_tpl->getVariable('user')->value['logtime']){?> <a href="javascript:void(0)">最近登录: <?php echo dtktime(array('time'=>$_smarty_tpl->getVariable('user')->value['logtime']),$_smarty_tpl);?>
</a><?php }?>
