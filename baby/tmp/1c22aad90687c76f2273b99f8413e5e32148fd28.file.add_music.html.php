<?php /* Smarty version Smarty-3.0.6, created on 2014-11-04 13:15:02
         compiled from "/home/kingkong/Projects/php/baby/tpl/add_music.html" */ ?>
<?php /*%%SmartyHeaderCode:248511100545860d61b6d76-89629799%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1c22aad90687c76f2273b99f8413e5e32148fd28' => 
    array (
      0 => '/home/kingkong/Projects/php/baby/tpl/add_music.html',
      1 => 1336662480,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '248511100545860d61b6d76-89629799',
  'function' => 
  array (
  ),
  ...
  <div id="hearder_bg">
    ...
    <div id="main">
      ...
      <div id="mountchange">
         ...
         <!-- <li><a href="">搜索音乐</a></li> -->
          <?php if ($_smarty_tpl->getVariable('dtk')->value['addmusic_up_switch']==1){?> <li id="url_upload"><a href="javascript:void(0)" onclick="SelectUpload(this)">本地上传</a></li><?php }?>
          </ul>
      </div>
...
" target="_blank">需要获取帮助?</a></li>
    ...
    <div id="musicUpload" style="display:none">
        ...
        您可以上传小于 <strong><?php echo formatBytes(array('size'=>$_smarty_tpl->getVariable('dtk')->value['addmusic_upsize']),$_smarty_tpl);?>
