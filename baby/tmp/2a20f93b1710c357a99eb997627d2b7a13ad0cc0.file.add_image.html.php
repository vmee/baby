<?php /* Smarty version Smarty-3.0.6, created on 2014-11-04 13:15:21
         compiled from "/home/kingkong/Projects/php/baby/tpl/add_image.html" */ ?>
<?php /*%%SmartyHeaderCode:295409075545860e93abd80-04870726%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2a20f93b1710c357a99eb997627d2b7a13ad0cc0' => 
    array (
      0 => '/home/kingkong/Projects/php/baby/tpl/add_image.html',
      1 => 1336877064,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '295409075545860e93abd80-04870726',
  'function' => 
  array (
  ),
...
/tpl/image/add/clear.gif" /> 删除文件</span></a> <a href="javascript:void(0);" id="btnStart" onclick="startUploadFiles();" class="btn"><span>开始上传</span></a></div>
     ...
     <div id="progressArea">
      ...
      <div class="upimgBar">
            ...
            <div id="upimgText">在文件列表中，您可以按住Shift多选。jpg,png,bmp.每张不超过<?php echo formatBytes(array('size'=>$_smarty_tpl->getVariable('dtk')->value['addimg_upsize']),$_smarty_tpl);?>
,最多发布<?php echo $_smarty_tpl->getVariable('dtk')->value['addimg_count'];?>
张</div>
            <div class="clear"></div>
        </div>
...
"/>
      <input type="hidden" name="uploadcount" id="uploadcount" value="<?php echo $_smarty_tpl->getVariable('dtk')->value['addimg_count'];?>
" />
      <input type="hidden" name="uploadcount" id="uploadmaxsize" value="<?php echo formatBytes(array('size'=>$_smarty_tpl->getVariable('dtk')->value['addimg_upsize']),$_smarty_tpl);?>
" />
