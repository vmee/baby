<?php /* Smarty version Smarty-3.0.6, created on 2014-11-03 17:24:21
         compiled from "/home/kingkong/Projects/php/baby/tpl/require_feeds.html" */ ?>
<?php /*%%SmartyHeaderCode:790095098545749c5c98c67-48678949%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fac99c1e6dee443a395632ce82ff5410428957f1' => 
    array (
      0 => '/home/kingkong/Projects/php/baby/tpl/require_feeds.html',
      1 => 1336814763,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '790095098545749c5c98c67-48678949',
  'function' => 
  array (
  ),
...
"/></div></a>
     ...
     <div class="header">
		<h1><?php if ($_smarty_tpl->tpl_vars['d']->value['title']){?> <a href="<?php echo goUserBlog(array('bid'=>$_smarty_tpl->tpl_vars['d']->value['bid']),$_smarty_tpl);?>
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['d']->value['title'];?>
</a><?php }else{ ?>无题<?php }?></h1>
		<span id="pubtime"><?php echo dtktime(array('time'=>$_smarty_tpl->tpl_vars['d']->value['time']),$_smarty_tpl);?>
</span>
		<!--<a href="<?php echo goUserHome(array('domain'=>$_smarty_tpl->tpl_vars['d']->value['domain'],'uid'=>$_smarty_tpl->tpl_vars['d']->value['uid']),$_smarty_tpl);?>
...
" class="content">
     ...
     <div class="footer">
	 <div class="tag"><div class="lable">标签:</div><?php echo tag(array('tag'=>$_smarty_tpl->tpl_vars['d']->value['tag'],'c'=>'tag'),$_smarty_tpl);?>
 </div>
	  <div class="mark">
			<div id="mark0" onmouseover="this.style.backgroundPosition='0 0'" onmouseout="this.style.backgroundPosition='-67px 0'" onfocus="this.blur()" onClick="sEval(<?php echo $_smarty_tpl->tpl_vars['d']->value['bid'];?>
,1)">
				<span id="barnum1"><span id="<?php echo $_smarty_tpl->tpl_vars['d']->value['bid'];?>
"><?php echo $_smarty_tpl->tpl_vars['d']->value['good_num'];?>
</span></span>
			</div>
			<div id="mark1" onmouseover="this.style.backgroundPosition='-202px 0'" onmouseout="this.style.backgroundPosition='-135px 0'" onfocus="this.blur()" onclick="sEval(<?php echo $_smarty_tpl->tpl_vars['d']->value['bid'];?>
,2)">
				<span id="barnum2"><span id="s<?php echo $_smarty_tpl->tpl_vars['d']->value['bid'];?>
"><?php echo $_smarty_tpl->tpl_vars['d']->value['bad_num'];?>
</span></span>
			</div>
		</div>
      <div class="menu">
...
/index.php?c=main&a=collect&bid=<?php echo $_smarty_tpl->tpl_vars['d']->value['bid'];?>
')">收集</a> 
